...
class Iface(object):
    ...
    def command_request(self, seq, block_id, args):
        """
        Parameters:
         - seq
         - block_id
    ...
    def chain_request(self, seq, block_id, args):
        """
        Parameters:
         - seq
         - block_id
...
class Client(Iface):
    ...
    def command_request(self, seq, block_id, args):
        ...
        """
        self.send_command_request(seq, block_id, args)

    def send_command_request(self, seq, block_id, args):
    ...
    def chain_request(self, seq, block_id, args):
        ...
        """
        self.send_chain_request(seq, block_id, args)

    def send_chain_request(self, seq, block_id, args):
...
class Processor(Iface, TProcessor):
    ...
    def process_command_request(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.command_request(args.seq, args.block_id, args.args)
        except TTransport.TTransportException:
            raise
        except Exception:
    ...
    def process_chain_request(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.chain_request(args.seq, args.block_id, args.args)
        except TTransport.TTransportException:
            raise
        except Exception:
            logging.exception('Exception in oneway handler')
...
class command_request_args(object):
    ...
    def __init__(self, seq=None, block_id=None, args=None,):
        self.seq = seq
        self.block_id = block_id
        self.args = args
    ...
    def write(self, oprot):
        ...
        if self.args is not None:
            oprot.writeFieldBegin('args', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.args))
            for iter6 in self.args:
...
command_request_args.thrift_spec = (
    ...
    (3, TType.LIST, 'args', (TType.STRING, 'BINARY', False), None, ),  # 3
)
