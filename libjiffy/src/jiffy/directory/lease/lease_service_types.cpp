...
rpc_lease_ack::~rpc_lease_ack() noexcept {
}
...
rpc_lease_ack::rpc_lease_ack(const rpc_lease_ack& other0) noexcept {
  renewed = other0.renewed;
  lease_period_ms = other0.lease_period_ms;
}
rpc_lease_ack& rpc_lease_ack::operator=(const rpc_lease_ack& other1) noexcept {
...
lease_service_exception::~lease_service_exception() noexcept {
}
...
const char* lease_service_exception::what() const noexcept {
  try {
    std::stringstream ss;
