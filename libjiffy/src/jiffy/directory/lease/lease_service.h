...
class lease_serviceIfSingletonFactory : virtual public lease_serviceIfFactory {
 public:
  lease_serviceIfSingletonFactory(const ::std::shared_ptr<lease_serviceIf>& iface) : iface_(iface) {}
  virtual ~lease_serviceIfSingletonFactory() {}

  virtual lease_serviceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(lease_serviceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<lease_serviceIf> iface_;
};
...
class lease_service_renew_leases_args {
 public:
  ...
  lease_service_renew_leases_args() noexcept {
  }

  virtual ~lease_service_renew_leases_args() noexcept;
...
class lease_service_renew_leases_pargs {
 public:
  ...
  virtual ~lease_service_renew_leases_pargs() noexcept;
...
class lease_service_renew_leases_result {
 public:
  ...
  lease_service_renew_leases_result() noexcept {
  }

  virtual ~lease_service_renew_leases_result() noexcept;
...
class lease_service_renew_leases_presult {
 public:
  ...
  virtual ~lease_service_renew_leases_presult() noexcept;
  rpc_lease_ack* success;
  lease_service_exception ex;
...
class lease_serviceClientT : virtual public lease_serviceIf {
 public:
  lease_serviceClientT(std::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  lease_serviceClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) {
...
class lease_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  lease_serviceProcessorT(::std::shared_ptr<lease_serviceIf> iface) :
    iface_(iface) {
...
class lease_serviceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  lease_serviceProcessorFactoryT(const ::std::shared_ptr< lease_serviceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< lease_serviceIfFactory > handlerFactory_;
};
...
class lease_serviceMultiface : virtual public lease_serviceIf {
 public:
  lease_serviceMultiface(std::vector<std::shared_ptr<lease_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~lease_serviceMultiface() {}
 protected:
  std::vector<std::shared_ptr<lease_serviceIf> > ifaces_;
  lease_serviceMultiface() {}
  void add(::std::shared_ptr<lease_serviceIf> iface) {
...
class lease_serviceConcurrentClientT : virtual public lease_serviceIf {
 public:
  lease_serviceConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(prot);
  }
  lease_serviceConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(iprot,oprot);
  }
 private:
