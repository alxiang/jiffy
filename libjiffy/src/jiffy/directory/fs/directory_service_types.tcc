    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->storage_mode = static_cast<rpc_storage_mode>(ecast5);
...
uint32_t rpc_replica_chain::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->storage_mode));
  xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<rpc_file_type>(ecast9);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
