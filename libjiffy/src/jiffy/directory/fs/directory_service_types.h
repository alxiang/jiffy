...
class rpc_replica_chain {
 public:
  ...
  rpc_replica_chain() noexcept
                    : name(),
                      metadata(),
                      storage_mode(static_cast<rpc_storage_mode>(0)) {
  }

  virtual ~rpc_replica_chain() noexcept;
...
class rpc_file_status {
 public:
  ...
  rpc_file_status(const rpc_file_status&) noexcept;
  rpc_file_status& operator=(const rpc_file_status&) noexcept;
  rpc_file_status() noexcept
                  : type(static_cast<rpc_file_type>(0)),
                    permissions(0),
                    last_write_time(0) {
  }

  virtual ~rpc_file_status() noexcept;
  /**
   * 
   * @see rpc_file_type
   */
...
class rpc_data_status {
 public:
  ...
  virtual ~rpc_data_status() noexcept;
  std::string type;
...
class rpc_dir_entry {
 public:
  ...
  rpc_dir_entry() noexcept
                : name() {
  }

  virtual ~rpc_dir_entry() noexcept;
  std::string name;
...
class directory_service_exception : public ::apache::thrift::TException {
 public:
  ...
  directory_service_exception() noexcept
                              : msg() {
  }

  virtual ~directory_service_exception() noexcept;
  std::string msg;
