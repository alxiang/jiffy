...
class directory_serviceIfSingletonFactory : virtual public directory_serviceIfFactory {
 public:
  directory_serviceIfSingletonFactory(const ::std::shared_ptr<directory_serviceIf>& iface) : iface_(iface) {}
  virtual ~directory_serviceIfSingletonFactory() {}

  virtual directory_serviceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(directory_serviceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<directory_serviceIf> iface_;
};
...
class directory_serviceNull : virtual public directory_serviceIf {
 public:
  ...
  void set_permissions(const std::string& /* path */, const rpc_perms /* perms */, const rpc_perm_options /* opts */) override {
    return;
  }
  ...
  void add_data_block(rpc_replica_chain& /* _return */, const std::string& /* path */, const std::string& /* partition_name */, const std::string& /* partition_metadata */) override {
    return;
  }
  void remove_data_block(const std::string& /* path */, const std::string& /* partition_name */) override {
    return;
  }
  void request_partition_data_update(const std::string& /* path */, const std::string& /* old_partition_name */, const std::string& /* new_partition_name */, const std::string& /* partition_metadata */) override {
    return;
  }
...
class directory_service_create_directory_args {
 public:
  ...
  directory_service_create_directory_args() noexcept
                                          : path() {
  }

  virtual ~directory_service_create_directory_args() noexcept;
  std::string path;
...
class directory_service_create_directory_pargs {
 public:
  ...
  virtual ~directory_service_create_directory_pargs() noexcept;
...
class directory_service_create_directory_result {
 public:
  ...
  directory_service_create_directory_result() noexcept {
  }

  virtual ~directory_service_create_directory_result() noexcept;
...
class directory_service_create_directory_presult {
 public:
  ...
  virtual ~directory_service_create_directory_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_create_directories_args {
 public:
  ...
  directory_service_create_directories_args() noexcept
                                            : path() {
  }

  virtual ~directory_service_create_directories_args() noexcept;
  std::string path;
...
class directory_service_create_directories_pargs {
 public:
  ...
  virtual ~directory_service_create_directories_pargs() noexcept;
  const std::string* path;
...
class directory_service_create_directories_result {
 public:
  ...
  directory_service_create_directories_result() noexcept {
  }

  virtual ~directory_service_create_directories_result() noexcept;
  directory_service_exception ex;
...
class directory_service_create_directories_presult {
 public:
  ...
  virtual ~directory_service_create_directories_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_open_args {
 public:
  ...
  directory_service_open_args() noexcept
                              : path() {
  }

  virtual ~directory_service_open_args() noexcept;
  std::string path;
...
class directory_service_open_pargs {
 public:
  ...
  virtual ~directory_service_open_pargs() noexcept;
  const std::string* path;
...
class directory_service_open_result {
 public:
  ...
  directory_service_open_result() noexcept {
  }

  virtual ~directory_service_open_result() noexcept;
...
class directory_service_open_presult {
 public:
  ...
  virtual ~directory_service_open_presult() noexcept;
  rpc_data_status* success;
  directory_service_exception ex;
...
class directory_service_create_args {
 public:
  ...
  directory_service_create_args() noexcept
                                : path(),
                                  type(),
                                  backing_path(),
                                  num_blocks(0),
  ...
  virtual ~directory_service_create_args() noexcept;
  std::string path;
  std::string type;
...
class directory_service_create_pargs {
 public:
  ...
  virtual ~directory_service_create_pargs() noexcept;
  const std::string* path;
...
class directory_service_create_result {
 public:
  ...
  directory_service_create_result() noexcept {
  }

  virtual ~directory_service_create_result() noexcept;
  rpc_data_status success;
  directory_service_exception ex;
...
class directory_service_create_presult {
 public:
  ...
  virtual ~directory_service_create_presult() noexcept;
  rpc_data_status* success;
  directory_service_exception ex;
...
class directory_service_open_or_create_args {
 public:
  ...
  directory_service_open_or_create_args() noexcept
                                        : path(),
                                          type(),
                                          backing_path(),
                                          num_blocks(0),
  ...
  virtual ~directory_service_open_or_create_args() noexcept;
  std::string path;
  std::string type;
  std::string backing_path;
  int32_t num_blocks;
...
class directory_service_open_or_create_pargs {
 public:
  ...
  virtual ~directory_service_open_or_create_pargs() noexcept;
  const std::string* path;
  const std::string* type;
  const std::string* backing_path;
  const int32_t* num_blocks;
...
class directory_service_open_or_create_result {
 public:
  ...
  directory_service_open_or_create_result() noexcept {
  }

  virtual ~directory_service_open_or_create_result() noexcept;
  rpc_data_status success;
  directory_service_exception ex;
...
class directory_service_open_or_create_presult {
 public:
  ...
  virtual ~directory_service_open_or_create_presult() noexcept;
  rpc_data_status* success;
  directory_service_exception ex;
...
class directory_service_exists_args {
 public:
  ...
  directory_service_exists_args() noexcept
                                : path() {
  }

  virtual ~directory_service_exists_args() noexcept;
  std::string path;
...
class directory_service_exists_pargs {
 public:
  ...
  virtual ~directory_service_exists_pargs() noexcept;
  const std::string* path;
...
class directory_service_exists_result {
 public:
  ...
  directory_service_exists_result() noexcept
                                  : success(0) {
  }

  virtual ~directory_service_exists_result() noexcept;
  bool success;
  directory_service_exception ex;
...
class directory_service_exists_presult {
 public:
  ...
  virtual ~directory_service_exists_presult() noexcept;
  bool* success;
  directory_service_exception ex;
...
class directory_service_last_write_time_args {
 public:
  ...
  directory_service_last_write_time_args() noexcept
                                         : path() {
  }

  virtual ~directory_service_last_write_time_args() noexcept;
  std::string path;
...
class directory_service_last_write_time_pargs {
 public:
  ...
  virtual ~directory_service_last_write_time_pargs() noexcept;
  const std::string* path;
...
class directory_service_last_write_time_result {
 public:
  ...
  directory_service_last_write_time_result() noexcept
                                           : success(0) {
  }

  virtual ~directory_service_last_write_time_result() noexcept;
  int64_t success;
  directory_service_exception ex;
...
class directory_service_last_write_time_presult {
 public:
  ...
  virtual ~directory_service_last_write_time_presult() noexcept;
  int64_t* success;
  directory_service_exception ex;
...
class directory_service_set_permissions_args {
 public:
  ...
  directory_service_set_permissions_args() noexcept
                                         : path(),
                                           perms(0),
                                           opts(static_cast<rpc_perm_options>(0)) {
  }

  virtual ~directory_service_set_permissions_args() noexcept;
  std::string path;
  rpc_perms perms;
  /**
   * 
...
class directory_service_set_permissions_pargs {
 public:
  ...
  virtual ~directory_service_set_permissions_pargs() noexcept;
  const std::string* path;
...
class directory_service_set_permissions_result {
 public:
  ...
  directory_service_set_permissions_result() noexcept {
  }

  virtual ~directory_service_set_permissions_result() noexcept;
  directory_service_exception ex;
...
class directory_service_set_permissions_presult {
 public:
  ...
  virtual ~directory_service_set_permissions_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_get_permissions_args {
 public:
  ...
  directory_service_get_permissions_args() noexcept
                                         : path() {
  }

  virtual ~directory_service_get_permissions_args() noexcept;
  std::string path;
...
class directory_service_get_permissions_pargs {
 public:
  ...
  virtual ~directory_service_get_permissions_pargs() noexcept;
  const std::string* path;
...
class directory_service_get_permissions_result {
 public:
  ...
  directory_service_get_permissions_result() noexcept
                                           : success(0) {
  }

  virtual ~directory_service_get_permissions_result() noexcept;
  rpc_perms success;
  directory_service_exception ex;
...
class directory_service_get_permissions_presult {
 public:
  ...
  virtual ~directory_service_get_permissions_presult() noexcept;
  rpc_perms* success;
  directory_service_exception ex;
...
class directory_service_remove_args {
 public:
  ...
  directory_service_remove_args() noexcept
                                : path() {
  }

  virtual ~directory_service_remove_args() noexcept;
  std::string path;
...
class directory_service_remove_pargs {
 public:
  ...
  virtual ~directory_service_remove_pargs() noexcept;
  const std::string* path;
...
class directory_service_remove_result {
 public:
  ...
  directory_service_remove_result() noexcept {
  }

  virtual ~directory_service_remove_result() noexcept;
  directory_service_exception ex;
...
class directory_service_remove_presult {
 public:
  ...
  virtual ~directory_service_remove_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_remove_all_args {
 public:
  ...
  directory_service_remove_all_args() noexcept
                                    : path() {
  }

  virtual ~directory_service_remove_all_args() noexcept;
  std::string path;
...
class directory_service_remove_all_pargs {
 public:
  ...
  virtual ~directory_service_remove_all_pargs() noexcept;
  const std::string* path;
...
class directory_service_remove_all_result {
 public:
  ...
  directory_service_remove_all_result() noexcept {
  }

  virtual ~directory_service_remove_all_result() noexcept;
  directory_service_exception ex;
...
class directory_service_remove_all_presult {
 public:
  ...
  virtual ~directory_service_remove_all_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_sync_args {
 public:
  ...
  directory_service_sync_args() noexcept
                              : path(),
                                backing_path() {
  }

  virtual ~directory_service_sync_args() noexcept;
  std::string path;
  std::string backing_path;
...
class directory_service_sync_pargs {
 public:
  ...
  virtual ~directory_service_sync_pargs() noexcept;
  const std::string* path;
  const std::string* backing_path;
...
class directory_service_sync_result {
 public:
  ...
  directory_service_sync_result() noexcept {
  }

  virtual ~directory_service_sync_result() noexcept;
  directory_service_exception ex;
...
class directory_service_sync_presult {
 public:
  ...
  virtual ~directory_service_sync_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_dump_args {
 public:
  ...
  directory_service_dump_args() noexcept
                              : path(),
                                backing_path() {
  }

  virtual ~directory_service_dump_args() noexcept;
  std::string path;
  std::string backing_path;
...
class directory_service_dump_pargs {
 public:
  ...
  virtual ~directory_service_dump_pargs() noexcept;
  const std::string* path;
  const std::string* backing_path;
...
class directory_service_dump_result {
 public:
  ...
  directory_service_dump_result() noexcept {
  }

  virtual ~directory_service_dump_result() noexcept;
  directory_service_exception ex;
...
class directory_service_dump_presult {
 public:
  ...
  virtual ~directory_service_dump_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_load_args {
 public:
  ...
  directory_service_load_args() noexcept
                              : path(),
                                backing_path() {
  }

  virtual ~directory_service_load_args() noexcept;
  std::string path;
  std::string backing_path;
...
class directory_service_load_pargs {
 public:
  ...
  virtual ~directory_service_load_pargs() noexcept;
  const std::string* path;
  const std::string* backing_path;
...
class directory_service_load_result {
 public:
  ...
  directory_service_load_result() noexcept {
  }

  virtual ~directory_service_load_result() noexcept;
  directory_service_exception ex;
...
class directory_service_load_presult {
 public:
  ...
  virtual ~directory_service_load_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_rename_args {
 public:
  ...
  directory_service_rename_args() noexcept
                                : old_path(),
                                  new_path() {
  }

  virtual ~directory_service_rename_args() noexcept;
  std::string old_path;
  std::string new_path;
...
class directory_service_rename_pargs {
 public:
  ...
  virtual ~directory_service_rename_pargs() noexcept;
...
class directory_service_rename_result {
 public:
  ...
  directory_service_rename_result() noexcept {
  }

  virtual ~directory_service_rename_result() noexcept;
  directory_service_exception ex;
...
class directory_service_rename_presult {
 public:
  ...
  virtual ~directory_service_rename_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_status_args {
 public:
  ...
  directory_service_status_args() noexcept
                                : path() {
  }

  virtual ~directory_service_status_args() noexcept;
  std::string path;
...
class directory_service_status_pargs {
 public:
  ...
  virtual ~directory_service_status_pargs() noexcept;
  const std::string* path;
...
class directory_service_status_result {
 public:
  ...
  directory_service_status_result() noexcept {
  }

  virtual ~directory_service_status_result() noexcept;
...
class directory_service_status_presult {
 public:
  ...
  virtual ~directory_service_status_presult() noexcept;
  rpc_file_status* success;
  directory_service_exception ex;
...
class directory_service_directory_entries_args {
 public:
  ...
  directory_service_directory_entries_args() noexcept
                                           : path() {
  }

  virtual ~directory_service_directory_entries_args() noexcept;
  std::string path;
...
class directory_service_directory_entries_pargs {
 public:
  ...
  virtual ~directory_service_directory_entries_pargs() noexcept;
  const std::string* path;
...
class directory_service_directory_entries_result {
 public:
  ...
  directory_service_directory_entries_result() noexcept {
  }

  virtual ~directory_service_directory_entries_result() noexcept;
...
class directory_service_directory_entries_presult {
 public:
  ...
  virtual ~directory_service_directory_entries_presult() noexcept;
  std::vector<rpc_dir_entry> * success;
  directory_service_exception ex;
...
class directory_service_recursive_directory_entries_args {
 public:
  ...
  directory_service_recursive_directory_entries_args() noexcept
                                                     : path() {
  }

  virtual ~directory_service_recursive_directory_entries_args() noexcept;
  std::string path;
...
class directory_service_recursive_directory_entries_pargs {
 public:
  ...
  virtual ~directory_service_recursive_directory_entries_pargs() noexcept;
  const std::string* path;
...
class directory_service_recursive_directory_entries_result {
 public:
  ...
  directory_service_recursive_directory_entries_result() noexcept {
  }

  virtual ~directory_service_recursive_directory_entries_result() noexcept;
  std::vector<rpc_dir_entry>  success;
  directory_service_exception ex;
...
class directory_service_recursive_directory_entries_presult {
 public:
  ...
  virtual ~directory_service_recursive_directory_entries_presult() noexcept;
  std::vector<rpc_dir_entry> * success;
  directory_service_exception ex;
...
class directory_service_dstatus_args {
 public:
  ...
  directory_service_dstatus_args() noexcept
                                 : path() {
  }

  virtual ~directory_service_dstatus_args() noexcept;
  std::string path;
...
class directory_service_dstatus_pargs {
 public:
  ...
  virtual ~directory_service_dstatus_pargs() noexcept;
  const std::string* path;
...
class directory_service_dstatus_result {
 public:
  ...
  directory_service_dstatus_result() noexcept {
  }

  virtual ~directory_service_dstatus_result() noexcept;
  rpc_data_status success;
  directory_service_exception ex;
...
class directory_service_dstatus_presult {
 public:
  ...
  virtual ~directory_service_dstatus_presult() noexcept;
  rpc_data_status* success;
  directory_service_exception ex;
...
class directory_service_add_tags_args {
 public:
  ...
  directory_service_add_tags_args() noexcept
                                  : path() {
  }

  virtual ~directory_service_add_tags_args() noexcept;
  std::string path;
  std::map<std::string, std::string>  tags;
...
class directory_service_add_tags_pargs {
 public:
  ...
  virtual ~directory_service_add_tags_pargs() noexcept;
  const std::string* path;
  const std::map<std::string, std::string> * tags;
...
class directory_service_add_tags_result {
 public:
  ...
  directory_service_add_tags_result() noexcept {
  }

  virtual ~directory_service_add_tags_result() noexcept;
  directory_service_exception ex;
...
class directory_service_add_tags_presult {
 public:
  ...
  virtual ~directory_service_add_tags_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_is_regular_file_args {
 public:
  ...
  directory_service_is_regular_file_args() noexcept
                                         : path() {
  }

  virtual ~directory_service_is_regular_file_args() noexcept;
  std::string path;
...
class directory_service_is_regular_file_pargs {
 public:
  ...
  virtual ~directory_service_is_regular_file_pargs() noexcept;
  const std::string* path;
...
class directory_service_is_regular_file_result {
 public:
  ...
  directory_service_is_regular_file_result() noexcept
                                           : success(0) {
  }

  virtual ~directory_service_is_regular_file_result() noexcept;
  bool success;
  directory_service_exception ex;
...
class directory_service_is_regular_file_presult {
 public:
  ...
  virtual ~directory_service_is_regular_file_presult() noexcept;
  bool* success;
  directory_service_exception ex;
...
class directory_service_is_directory_args {
 public:
  ...
  directory_service_is_directory_args() noexcept
                                      : path() {
  }

  virtual ~directory_service_is_directory_args() noexcept;
  std::string path;
...
class directory_service_is_directory_pargs {
 public:
  ...
  virtual ~directory_service_is_directory_pargs() noexcept;
  const std::string* path;
...
class directory_service_is_directory_result {
 public:
  ...
  directory_service_is_directory_result() noexcept
                                        : success(0) {
  }

  virtual ~directory_service_is_directory_result() noexcept;
  bool success;
  directory_service_exception ex;
...
class directory_service_is_directory_presult {
 public:
  ...
  virtual ~directory_service_is_directory_presult() noexcept;
  bool* success;
  directory_service_exception ex;
...
class directory_service_reslove_failures_args {
 public:
  ...
  directory_service_reslove_failures_args() noexcept
                                          : path() {
  }

  virtual ~directory_service_reslove_failures_args() noexcept;
  std::string path;
...
class directory_service_reslove_failures_pargs {
 public:
  ...
  virtual ~directory_service_reslove_failures_pargs() noexcept;
  const std::string* path;
...
class directory_service_reslove_failures_result {
 public:
  ...
  directory_service_reslove_failures_result() noexcept {
  }

  virtual ~directory_service_reslove_failures_result() noexcept;
...
class directory_service_reslove_failures_presult {
 public:
  ...
  virtual ~directory_service_reslove_failures_presult() noexcept;
  rpc_replica_chain* success;
  directory_service_exception ex;
...
class directory_service_add_replica_to_chain_args {
 public:
  ...
  directory_service_add_replica_to_chain_args() noexcept
                                              : path() {
  }

  virtual ~directory_service_add_replica_to_chain_args() noexcept;
  std::string path;
  rpc_replica_chain chain;
...
class directory_service_add_replica_to_chain_pargs {
 public:
  ...
  virtual ~directory_service_add_replica_to_chain_pargs() noexcept;
  const std::string* path;
  const rpc_replica_chain* chain;
...
class directory_service_add_replica_to_chain_result {
 public:
  ...
  directory_service_add_replica_to_chain_result() noexcept {
  }

  virtual ~directory_service_add_replica_to_chain_result() noexcept;
  rpc_replica_chain success;
  directory_service_exception ex;
...
class directory_service_add_replica_to_chain_presult {
 public:
  ...
  virtual ~directory_service_add_replica_to_chain_presult() noexcept;
  rpc_replica_chain* success;
  directory_service_exception ex;
...
class directory_service_add_data_block_args {
 public:
  ...
  directory_service_add_data_block_args() noexcept
                                        : path(),
                                          partition_name(),
                                          partition_metadata() {
  }

  virtual ~directory_service_add_data_block_args() noexcept;
  std::string path;
...
class directory_service_add_data_block_pargs {
 public:
  ...
  virtual ~directory_service_add_data_block_pargs() noexcept;
  const std::string* path;
...
class directory_service_add_data_block_result {
 public:
  ...
  directory_service_add_data_block_result() noexcept {
  }

  virtual ~directory_service_add_data_block_result() noexcept;
  rpc_replica_chain success;
  directory_service_exception ex;
...
class directory_service_add_data_block_presult {
 public:
  ...
  virtual ~directory_service_add_data_block_presult() noexcept;
  rpc_replica_chain* success;
  directory_service_exception ex;
...
class directory_service_remove_data_block_args {
 public:
  ...
  directory_service_remove_data_block_args() noexcept
                                           : path(),
                                             partition_name() {
  }

  virtual ~directory_service_remove_data_block_args() noexcept;
  std::string path;
  std::string partition_name;
...
class directory_service_remove_data_block_pargs {
 public:
  ...
  virtual ~directory_service_remove_data_block_pargs() noexcept;
  const std::string* path;
  const std::string* partition_name;
...
class directory_service_remove_data_block_result {
 public:
  ...
  directory_service_remove_data_block_result() noexcept {
  }

  virtual ~directory_service_remove_data_block_result() noexcept;
  directory_service_exception ex;
...
class directory_service_remove_data_block_presult {
 public:
  ...
  virtual ~directory_service_remove_data_block_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_request_partition_data_update_args {
 public:
  ...
  directory_service_request_partition_data_update_args() noexcept
                                                       : path(),
                                                         old_partition_name(),
                                                         new_partition_name(),
                                                         partition_metadata() {
  ...
  virtual ~directory_service_request_partition_data_update_args() noexcept;
  std::string path;
...
class directory_service_request_partition_data_update_pargs {
 public:
  ...
  virtual ~directory_service_request_partition_data_update_pargs() noexcept;
  const std::string* path;
...
class directory_service_request_partition_data_update_result {
 public:
  ...
  directory_service_request_partition_data_update_result() noexcept {
  }

  virtual ~directory_service_request_partition_data_update_result() noexcept;
  directory_service_exception ex;
...
class directory_service_request_partition_data_update_presult {
 public:
  ...
  virtual ~directory_service_request_partition_data_update_presult() noexcept;
  directory_service_exception ex;
...
class directory_service_get_storage_capacity_args {
 public:
  ...
  directory_service_get_storage_capacity_args() noexcept
                                              : path(),
                                                partition_name() {
  }

  virtual ~directory_service_get_storage_capacity_args() noexcept;
  std::string path;
  std::string partition_name;
...
class directory_service_get_storage_capacity_pargs {
 public:
  ...
  virtual ~directory_service_get_storage_capacity_pargs() noexcept;
  const std::string* path;
  const std::string* partition_name;
...
class directory_service_get_storage_capacity_result {
 public:
  ...
  directory_service_get_storage_capacity_result() noexcept
                                                : success(0) {
  }

  virtual ~directory_service_get_storage_capacity_result() noexcept;
  int64_t success;
  directory_service_exception ex;
...
class directory_service_get_storage_capacity_presult {
 public:
  ...
  virtual ~directory_service_get_storage_capacity_presult() noexcept;
  int64_t* success;
  directory_service_exception ex;
...
class directory_serviceClientT : virtual public directory_serviceIf {
 public:
  directory_serviceClientT(std::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  directory_serviceClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) {
 ...
 public:
  ...
  void create(rpc_data_status& _return, const std::string& path, const std::string& type, const std::string& backing_path, const int32_t num_blocks, const int32_t chain_length, const int32_t flags, const int32_t permissions, const std::vector<std::string> & block_ids, const std::vector<std::string> & block_metadata, const std::map<std::string, std::string> & tags, const std::string &host_name) override;
...
class directory_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  directory_serviceProcessorT(::std::shared_ptr<directory_serviceIf> iface) :
    iface_(iface) {
...
class directory_serviceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  directory_serviceProcessorFactoryT(const ::std::shared_ptr< directory_serviceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< directory_serviceIfFactory > handlerFactory_;
};
...
class directory_serviceMultiface : virtual public directory_serviceIf {
 public:
  directory_serviceMultiface(std::vector<std::shared_ptr<directory_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~directory_serviceMultiface() {}
 protected:
  std::vector<std::shared_ptr<directory_serviceIf> > ifaces_;
  directory_serviceMultiface() {}
  void add(::std::shared_ptr<directory_serviceIf> iface) {
 ...
 public:
  ...
  void create(rpc_data_status& _return, const std::string& path, const std::string& type, const std::string& backing_path, const int32_t num_blocks, const int32_t chain_length, const int32_t flags, const int32_t permissions, const std::vector<std::string> & block_ids, const std::vector<std::string> & block_metadata, const std::map<std::string, std::string> & tags, const std::string &host_name) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->create(_return, path, type, backing_path, num_blocks, chain_length, flags, permissions, block_ids, block_metadata, tags, host_name);
    }
    ifaces_[i]->create(_return, path, type, backing_path, num_blocks, chain_length, flags, permissions, block_ids, block_metadata, tags, host_name);
    return;
  }
...
class directory_serviceConcurrentClientT : virtual public directory_serviceIf {
 public:
  directory_serviceConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(prot);
  }
  directory_serviceConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(iprot,oprot);
  }
 private:
