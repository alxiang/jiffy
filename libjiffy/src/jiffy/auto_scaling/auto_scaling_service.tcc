...
template <class Protocol_>
::std::shared_ptr< ::apache::thrift::TProcessor > auto_scaling_serviceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< auto_scaling_serviceIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< auto_scaling_serviceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new auto_scaling_serviceProcessorT<Protocol_>(handler));
  return processor;
}
