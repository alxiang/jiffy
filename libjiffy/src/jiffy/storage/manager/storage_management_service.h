...
class storage_management_serviceNull : virtual public storage_management_serviceIf {
 public:
  ...
  void create_partition(const int32_t /* block_id */, const std::string& /* partition_type */, const std::string& /* backing_path */, const std::string& /* partition_name */, const std::string& /* partition_metadata */, const std::map<std::string, std::string> & /* conf */) override {
    return;
  }
  void setup_chain(const int32_t /* block_id */, const std::string& /* path */, const std::vector<std::string> & /* chain */, const int32_t /* chain_role */, const std::string& /* next_block_id */) override {
    return;
  }
  void destroy_partition(const int32_t /* block_id */) override {
    return;
  }
  void get_path(std::string& /* _return */, const int32_t /* block_id */) override {
    return;
  }
  void sync(const int32_t /* block_id */, const std::string& /* backing_path */) override {
    return;
  }
  void dump(const int32_t /* block_id */, const std::string& /* backing_path */) override {
    return;
  }
  void load(const int32_t /* block_id */, const std::string& /* backing_path */) override {
    return;
  }
  ...
  void update_partition_data(const int32_t /* block_id */, const std::string& /* partition_name */, const std::string& /* partition_metadata */) override {
    return;
  }
};
...
class storage_management_service_create_partition_args {
 public:
  ...
  storage_management_service_create_partition_args() noexcept
                                                   : block_id(0),
                                                     partition_type(),
                                                     backing_path(),
                                                     partition_name(),
  ...
  virtual ~storage_management_service_create_partition_args() noexcept;
  int32_t block_id;
...
class storage_management_service_create_partition_pargs {
 public:
  ...
  virtual ~storage_management_service_create_partition_pargs() noexcept;
...
class storage_management_service_create_partition_result {
 public:
  ...
  storage_management_service_create_partition_result() noexcept {
  }

  virtual ~storage_management_service_create_partition_result() noexcept;
...
class storage_management_service_create_partition_presult {
 public:
  ...
  virtual ~storage_management_service_create_partition_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_setup_chain_args {
 public:
  ...
  storage_management_service_setup_chain_args() noexcept
                                              : block_id(0),
                                                path(),
                                                chain_role(0),
                                                next_block_id() {
  ...
  virtual ~storage_management_service_setup_chain_args() noexcept;
  int32_t block_id;
  std::string path;
...
class storage_management_service_setup_chain_pargs {
 public:
  ...
  virtual ~storage_management_service_setup_chain_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_setup_chain_result {
 public:
  ...
  storage_management_service_setup_chain_result() noexcept {
  }

  virtual ~storage_management_service_setup_chain_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_setup_chain_presult {
 public:
  ...
  virtual ~storage_management_service_setup_chain_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_destroy_partition_args {
 public:
  ...
  storage_management_service_destroy_partition_args(const storage_management_service_destroy_partition_args&) noexcept;
  storage_management_service_destroy_partition_args& operator=(const storage_management_service_destroy_partition_args&) noexcept;
  storage_management_service_destroy_partition_args() noexcept
                                                    : block_id(0) {
  }

  virtual ~storage_management_service_destroy_partition_args() noexcept;
  int32_t block_id;
...
class storage_management_service_destroy_partition_pargs {
 public:
  ...
  virtual ~storage_management_service_destroy_partition_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_destroy_partition_result {
 public:
  ...
  storage_management_service_destroy_partition_result() noexcept {
  }

  virtual ~storage_management_service_destroy_partition_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_destroy_partition_presult {
 public:
  ...
  virtual ~storage_management_service_destroy_partition_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_get_path_args {
 public:
  ...
  storage_management_service_get_path_args(const storage_management_service_get_path_args&) noexcept;
  storage_management_service_get_path_args& operator=(const storage_management_service_get_path_args&) noexcept;
  storage_management_service_get_path_args() noexcept
                                           : block_id(0) {
  }

  virtual ~storage_management_service_get_path_args() noexcept;
  int32_t block_id;
...
class storage_management_service_get_path_pargs {
 public:
  ...
  virtual ~storage_management_service_get_path_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_get_path_result {
 public:
  ...
  storage_management_service_get_path_result() noexcept
                                             : success() {
  }

  virtual ~storage_management_service_get_path_result() noexcept;
  std::string success;
  storage_management_exception ex;
...
class storage_management_service_get_path_presult {
 public:
  ...
  virtual ~storage_management_service_get_path_presult() noexcept;
  std::string* success;
  storage_management_exception ex;
...
class storage_management_service_sync_args {
 public:
  ...
  storage_management_service_sync_args() noexcept
                                       : block_id(0),
                                         backing_path() {
  }

  virtual ~storage_management_service_sync_args() noexcept;
  int32_t block_id;
  std::string backing_path;
...
class storage_management_service_sync_pargs {
 public:
  ...
  virtual ~storage_management_service_sync_pargs() noexcept;
  const int32_t* block_id;
  const std::string* backing_path;
...
class storage_management_service_sync_result {
 public:
  ...
  storage_management_service_sync_result() noexcept {
  }

  virtual ~storage_management_service_sync_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_sync_presult {
 public:
  ...
  virtual ~storage_management_service_sync_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_dump_args {
 public:
  ...
  storage_management_service_dump_args() noexcept
                                       : block_id(0),
                                         backing_path() {
  }

  virtual ~storage_management_service_dump_args() noexcept;
  int32_t block_id;
  std::string backing_path;
...
class storage_management_service_dump_pargs {
 public:
  ...
  virtual ~storage_management_service_dump_pargs() noexcept;
  const int32_t* block_id;
  const std::string* backing_path;
...
class storage_management_service_dump_result {
 public:
  ...
  storage_management_service_dump_result() noexcept {
  }

  virtual ~storage_management_service_dump_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_dump_presult {
 public:
  ...
  virtual ~storage_management_service_dump_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_load_args {
 public:
  ...
  storage_management_service_load_args() noexcept
                                       : block_id(0),
                                         backing_path() {
  }

  virtual ~storage_management_service_load_args() noexcept;
  int32_t block_id;
  std::string backing_path;
...
class storage_management_service_load_pargs {
 public:
  ...
  virtual ~storage_management_service_load_pargs() noexcept;
  const int32_t* block_id;
  const std::string* backing_path;
...
class storage_management_service_load_result {
 public:
  ...
  storage_management_service_load_result() noexcept {
  }

  virtual ~storage_management_service_load_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_load_presult {
 public:
  ...
  virtual ~storage_management_service_load_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_storage_capacity_args {
 public:
  ...
  storage_management_service_storage_capacity_args(const storage_management_service_storage_capacity_args&) noexcept;
  storage_management_service_storage_capacity_args& operator=(const storage_management_service_storage_capacity_args&) noexcept;
  storage_management_service_storage_capacity_args() noexcept
                                                   : block_id(0) {
  }

  virtual ~storage_management_service_storage_capacity_args() noexcept;
  int32_t block_id;
...
class storage_management_service_storage_capacity_pargs {
 public:
  ...
  virtual ~storage_management_service_storage_capacity_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_storage_capacity_result {
 public:
  ...
  storage_management_service_storage_capacity_result() noexcept
                                                     : success(0) {
  }

  virtual ~storage_management_service_storage_capacity_result() noexcept;
  int64_t success;
  storage_management_exception ex;
...
class storage_management_service_storage_capacity_presult {
 public:
  ...
  virtual ~storage_management_service_storage_capacity_presult() noexcept;
  int64_t* success;
  storage_management_exception ex;
...
class storage_management_service_storage_size_args {
 public:
  ...
  storage_management_service_storage_size_args(const storage_management_service_storage_size_args&) noexcept;
  storage_management_service_storage_size_args& operator=(const storage_management_service_storage_size_args&) noexcept;
  storage_management_service_storage_size_args() noexcept
                                               : block_id(0) {
  }

  virtual ~storage_management_service_storage_size_args() noexcept;
  int32_t block_id;
...
class storage_management_service_storage_size_pargs {
 public:
  ...
  virtual ~storage_management_service_storage_size_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_storage_size_result {
 public:
  ...
  storage_management_service_storage_size_result() noexcept
                                                 : success(0) {
  }

  virtual ~storage_management_service_storage_size_result() noexcept;
  int64_t success;
  storage_management_exception ex;
...
class storage_management_service_storage_size_presult {
 public:
  ...
  virtual ~storage_management_service_storage_size_presult() noexcept;
  int64_t* success;
  storage_management_exception ex;
...
class storage_management_service_resend_pending_args {
 public:
  ...
  storage_management_service_resend_pending_args(const storage_management_service_resend_pending_args&) noexcept;
  storage_management_service_resend_pending_args& operator=(const storage_management_service_resend_pending_args&) noexcept;
  storage_management_service_resend_pending_args() noexcept
                                                 : block_id(0) {
  }

  virtual ~storage_management_service_resend_pending_args() noexcept;
  int32_t block_id;
...
class storage_management_service_resend_pending_pargs {
 public:
  ...
  virtual ~storage_management_service_resend_pending_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_resend_pending_result {
 public:
  ...
  storage_management_service_resend_pending_result() noexcept {
  }

  virtual ~storage_management_service_resend_pending_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_resend_pending_presult {
 public:
  ...
  virtual ~storage_management_service_resend_pending_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_forward_all_args {
 public:
  ...
  storage_management_service_forward_all_args(const storage_management_service_forward_all_args&) noexcept;
  storage_management_service_forward_all_args& operator=(const storage_management_service_forward_all_args&) noexcept;
  storage_management_service_forward_all_args() noexcept
                                              : block_id(0) {
  }

  virtual ~storage_management_service_forward_all_args() noexcept;
  int32_t block_id;
...
class storage_management_service_forward_all_pargs {
 public:
  ...
  virtual ~storage_management_service_forward_all_pargs() noexcept;
  const int32_t* block_id;
...
class storage_management_service_forward_all_result {
 public:
  ...
  storage_management_service_forward_all_result() noexcept {
  }

  virtual ~storage_management_service_forward_all_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_forward_all_presult {
 public:
  ...
  virtual ~storage_management_service_forward_all_presult() noexcept;
  storage_management_exception ex;
...
class storage_management_service_update_partition_data_args {
 public:
  ...
  storage_management_service_update_partition_data_args() noexcept
                                                        : block_id(0),
                                                          partition_name(),
                                                          partition_metadata() {
  }

  virtual ~storage_management_service_update_partition_data_args() noexcept;
  int32_t block_id;
  std::string partition_name;
  std::string partition_metadata;
...
class storage_management_service_update_partition_data_pargs {
 public:
  ...
  virtual ~storage_management_service_update_partition_data_pargs() noexcept;
  const int32_t* block_id;
  const std::string* partition_name;
  const std::string* partition_metadata;
...
class storage_management_service_update_partition_data_result {
 public:
  ...
  storage_management_service_update_partition_data_result() noexcept {
  }

  virtual ~storage_management_service_update_partition_data_result() noexcept;
  storage_management_exception ex;
...
class storage_management_service_update_partition_data_presult {
 public:
  ...
  virtual ~storage_management_service_update_partition_data_presult() noexcept;
  storage_management_exception ex;
