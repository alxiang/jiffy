...
public class rpc_lease_ack implements org.apache.thrift.TBase<rpc_lease_ack, rpc_lease_ack._Fields>, java.io.Serializable, Cloneable, Comparable<rpc_lease_ack> {
  ...
  public int compareTo(rpc_lease_ack other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRenewed(), other.isSetRenewed());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLeasePeriodMs(), other.isSetLeasePeriodMs());
    if (lastComparison != 0) {
      return lastComparison;
    }
